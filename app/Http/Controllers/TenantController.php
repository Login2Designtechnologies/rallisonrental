...
class TenantController extends Controller
{
       ...
       public function store(Request $request)
    {
        ...
        if (\Auth::user()->can('create tenant')) {
            ...
            if ($request->personal_document != 'undefined') {
            ...
            if ($request->ic_document != 'undefined') {
            ...
            if ($request->miscellaneous != 'undefined') {
    ...
    public function edit(Tenant $tenant)
    {
        if (\Auth::user()->can('edit tenant')) {
            ...
            $statesdata = DB::table('states')->get();
            return view('tenant.edit', compact('property', 'tenant', 'user','statesdata'));
        } else {
            return redirect()->back()->with('error', __('Permission Denied!'));
        }
    }
