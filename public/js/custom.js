...
//     const options = {
//       format: 'mm-dd-yyyy', // Correct format for this plugin
//       autohide: true,
//       todayHighlight: true
//     };

//     // Initialize both inputs
//     const startInput = document.getElementById('lease_start_date');
...
//   });
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Initialize both inputs
    const startInput = document.getElementById('lease_start_date');
    const newinput = document.getElementById('start_date');
    const endInput = document.getElementById('lease_end_date');
    ...
    if (newinput) {
      new Datepicker(newinput, options);
    }
