    ...
    <div class="row">
        <div class=" col-md-12 row">
            ...
            {{--<!-- <div class="form-group  col-md-6">
                ...
                {{Form::select('property_id',$name,null,array('class'=>'form-control hidesearch','placeholder'=>__('Enter Property')))}}
            </div>
        </div>
        ...
        <div class="form-group col-md-12">
            {{Form::label('notes',__('Description'),array('class'=>'form-label'))}}
