...
<body class="landing-page" data-pc-preset="{{ $settings['accent_color'] }}" data-pc-sidebar-theme="light"
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto f-w-600">
                    ...
                    <li class="nav-item">
                       <a class="nav-link me-2 {{ (!empty($routeParameters['slug']) && $menu->slug == $routeParameters['slug']) ? 'active' : '' }}" href="{{ route('page',$menu->slug) }}">{{ $menu->title }}</a>
                   </li>
                    @endforeach
                    <li class="nav-item">
    ...
    <div class="front-header-image">
        ...
        <div class="privacy-details">
            ...
            <p class="text-center text-white pt-3 f-16">{{ __('Last updated on') }} {{ dateFormat($page->updated_at) }}</p>
        </div>
        <div class="container">
