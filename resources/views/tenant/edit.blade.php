                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="form-group col-lg-6 col-md-6">
                                ...
                                {{ Form::text('phone_number', $user->phone_number, ['class' => 'form-control', 'placeholder' => __('xxx-xxx-xxxx')]) }}
                            </div> -->

                            <div class="form-group col-lg-6 col-md-6">
                                {{ Form::label('phone_number', 'Phone Number', ['class' => 'form-label']) }} <span class="text-danger">*</span>
                                {{ Form::text('phone_number', $user->phone_number, ['class' => 'form-control phone_number', 'placeholder' => 'xxx-xxx-xxxx']) }}
                            </div>
                            <!-- <div class="form-group col-lg-6 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                @if ($user->profile)
                                    <div class="mt-2">
                                        <a href="{{ asset(Storage::url('upload/profile/' . $user->profile)) }}" target="_blank">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-md-4">
                                ...
                                @foreach($cities as $citieval)
                                    <option value="{{$citieval->id}}" {{ $tenant->city == $citieval->id ? 'selected' : '' }} style="">{{$citieval->name}}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="form-group col-lg-4 col-md-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($user->personal_document)
                                <div class="mt-2">
                                    <a href="{{ asset(Storage::url('upload/tenantdocument/' . $user->personal_document)) }}" target="_blank">
                                        <img src="{{ asset(Storage::url('upload/tenantdocument/' . $user->personal_document)) }}" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                                    <div class="small text-muted">Current photo</div>
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($user->ic_document)
                                <div class="mt-2">
                                    <a href="{{ asset(Storage::url('upload/tenantdocument/' . $user->ic_document)) }}" target="_blank">
                                        <img src="{{ asset(Storage::url('upload/tenantdocument/' . $user->ic_document)) }}" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if ($user->miscellaneous)
                                <div class="mt-2">
                                    <a href="{{ asset(Storage::url('upload/tenantdocument/' . $user->miscellaneous)) }}" target="_blank">
                                        <img src="{{ asset(Storage::url('upload/tenantdocument/' . $user->miscellaneous)) }}" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                                    <div class="small text-muted">Current</div>
                                </div>
