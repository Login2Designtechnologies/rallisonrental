    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                    ...
                    @if (Gate::check('manage tenant') || Gate::check('manage property') || Gate::check('manage unit'))
                        <li
                            ...
                            <a href="#!" class="pc-link">
                                ...
                                <span class="pc-mtext">{{ __('Property Management') }}</span>
                                <span class="pc-arrow"><i data-feather="chevron-right"></i></span>
                            </a>
                            <ul class="pc-submenu"
                    ...
                    <!-- @if (Gate::check('manage contact'))
                        <li class="pc-item {{ in_array($routeName, ['contact.index']) ? 'active' : '' }}">
                            <a href="{{ route('contact.index') }}" class="pc-link">
                                ...
                                <span class="pc-mtext">{{ __('Contract Management') }}</span>
                            </a>
                        </li>
                    @endif -->
                    <!-- @if (Gate::check('manage note'))
                        <li class="pc-item {{ in_array($routeName, ['note.index']) ? 'active' : '' }} ">
                            <a href="{{ route('note.index') }}" class="pc-link">
                                ...
                                <span class="pc-mtext">{{ __('Exit Notices') }}</span>
                            </a>
                        </li>
                    @endif -->
                ...
                @endif
                @if (Auth::check() && strtolower(Auth::user()->type) === 'owner')
                <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu" style="display: {{ request()->routeIs('property.*') || request()->routeIs('unit.*') ? 'block' : 'none' }}">
                            ...
                            @can('manage property') 
                                ...
                                <!-- <li class="pc-item {{ request()->routeIs('property.*') ? 'active' : '' }}">
                                    <a class="pc-link" href="{{ route('property.selectProperty') }}">{{ __('Select Property') }}</a>
                                </li> -->
                            @endcan

                            <!-- <li class="pc-item">
                                    <a class="pc-link" href="#">{{ __('Other Invoices') }}</a>
                                </li> -->

                            @can('manage unit')
                                <!-- <li class="pc-item {{ request()->routeIs('unit.*') ? 'active' : '' }}">
                                    <a class="pc-link" href="{{ route('unit.index') }}">{{ __('b') }}</a>
                                </li> -->
                            @endcan
                    ...
                    <li class="pc-item">
                        <a href="{{ url('payments') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-ticket"></i></span>
                            <span class="pc-mtext">{{ __('Payments & Account Summary') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (Auth::check() && Auth::user()->type === 'tenant')
                    <li class="pc-item">
                        <a href="{{ url('tenant-profile') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-user"></i></span>
                            <span class="pc-mtext">{{ __('Tenant Profile') }}</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ url('property-details') }}" class="pc-link">
                            <span class="pc-micon"><i class="ti ti-home"></i></span>
                            <span class="pc-mtext">{{ __('Property Details') }}</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ url('payment-section') }}" class="pc-link">
                            <span class="pc-micon"><i class="bi bi-wallet2"></i></span>
                            <span class="pc-mtext">{{ __('Payment & Invocie') }}</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ url('tenant-ticket-support') }}" class="pc-link">
                            <span class="pc-micon"><i class="bi bi-ticket"></i></span>
                            <span class="pc-mtext">{{ __('Ticket Support & Help') }}</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ url('tenant-notices') }}" class="pc-link">
                            <span class="pc-micon"><i class="bi bi-file-earmark-text"></i></span>
                            <span class="pc-mtext">{{ __('Notices') }}</span>
                        </a>
                    </li>
                    <li class="pc-item">
                        <a href="{{ url('tenant-documents') }}" class="pc-link">
                            <span class="pc-micon"><i class="bi bi-file-earmark-break"></i></span>
                            <span class="pc-mtext">{{ __('Documents') }}</span>
                        </a>
                    </li>
                    <!-- <li class="pc-item">
                        <a href="{{ url('utilities-invoices') }}" class="pc-link">
                            <span class="pc-micon"><i class="bi bi-receipt"></i></span>
                            <span class="pc-mtext">{{ __('Utilities Invoices') }}</span>
                        </a>
                    </li> -->
                    <!-- <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item">
                                <a class="pc-link" href="{{ url('utilities-invoices') }}">{{ __('Utilities Invoices') }}</a>
                            </li>
                            <li class="pc-item">
                                <a class="pc-link" href="{{ url('tenant-late-fees') }}">{{ __('Late Fee') }}</a>
                            </li>
                            <li class="pc-item">
                                <a class="pc-link" href="{{ url('tenant-other-invoice') }}">{{ __('Other') }}</a>
                            </li>
                        </ul>
                    </li> -->
                @endif
                ...
                @if (Gate::check('manage pricing packages') ||
                    ...
                    @endif
                        ...
                        <li class="pc-item ">
                            <a href="{{url('ticket-support')}}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-layout"></i></span>
                                <span class="pc-mtext">{{ __('Ticket & Support') }}</span>
                            </a>
                        </li>
                        <li class="pc-item ">
                            <a href="{{url('manage-notice')}}" class="pc-link">
                                <span class="pc-micon"><i class="ti ti-layout"></i></span>
                                <span class="pc-mtext">{{ __('Manage Notice') }}</span>
                            </a>
                        </li>
                        <li class="pc-item ">
