                ...
                <div class="card-header py-2 px-0">
                    <div class="row align-items-center g-2">
                        <div class="col">
                            ...
                            <div class="col-auto">
                                <a href="{{url('add-notice')}}" class="btn btn-secondary customModal" data-size="lg"
                                    data-url="{{url('add-notice')}}" data-title="{{ __('Create notice') }}"> <i
                                        class="ti ti-circle-plus align-text-bottom"></i> Create Manage Notice</a>
                            </div>
                    </div>
                </div>
