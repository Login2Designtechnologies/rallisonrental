  ...
  <div class="col-sm-12">
    <div class="">
      ...
      <div class="pt-0">
        ...
        <form action="{{ route('setup_late_fee') }}" method="post" id="lateFeeForm">
          @csrf
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  ...
                  <input
                    ...
                    value="{{ old('contract_cancel_days', data_get($saved, 'contract_cancel_days')) }}"
                  >
                ...
                <div class="col-md-6">
                  ...
                  <div class="input-group">
                    ...
                    <input
                      ...
                      value="{{ old('fixed_late_fee', data_get($saved, 'fixed_late_fee')) }}"
                    >
                  </div>
