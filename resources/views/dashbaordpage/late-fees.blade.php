        ...
        <form action="" id="" class="search-form">
                <div class="row g-3">
                    ...
                    <div class="col-sm-3 d-flex align-items-center justify-content-end">
                        ...
                        <a href="{{url('add-fee')}}" class="btn btn-secondary text-white"><i class="ti ti-circle-plus align-text-bottom"></i> Add New</a>
                    </div>
                </div>
            </form>
                ...
                <thead class="table-theme">
                 ...
                 <tbody>
                    <tr>
                        ...
                        <td>$300</td>
                        <td>
                            <a href="{{url('edit-late-fee')}}" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
