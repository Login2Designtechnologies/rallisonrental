                ...
                <?php if(Auth::check() && Auth::user()->type === 'tenant'): ?>
                    ...
                    <li class="pc-item">
                        <a href="<?php echo e(url('payment-section')); ?>" class="pc-link">
                            ...
                            <span class="pc-mtext"><?php echo e(__('Payment & Invocie')); ?></span>
                        </a>
                    </li>
                    <li class="pc-item">
...
<?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/admin/menu.blade.php ENDPATH**/ ?>