                                                ...
                                                <div class="cart-action">
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('show maintenance request')): ?>
                                                        <a class="text-warning customModal" data-bs-toggle="tooltip"
                                                            data-size="lg" data-bs-original-title="<?php echo e(__('View')); ?>"
                                                            href="#"
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit maintenance request')): ?>
                                                        <a class="text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            data-title="<?php echo e(__('Edit Maintenance Request')); ?>"> <i data-feather="edit"></i></a>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/maintenance_request/type.blade.php ENDPATH**/ ?>