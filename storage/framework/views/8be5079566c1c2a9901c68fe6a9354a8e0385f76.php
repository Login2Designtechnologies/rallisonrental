            ...
            <form action="" id="" class="search-form">
                <div class="row g-3">
                    ...
                    <div class="col-sm-3 d-flex align-items-center justify-content-end">
                        ...
                        <a href="<?php echo e(url('add-ticket')); ?>" class="btn btn-secondary text-white"><i class="ti ti-circle-plus align-text-bottom"></i> Create New Ticket</a>
                    </div>
                </div>
            </form>
        </div>
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <a href="<?php echo e(url('view-ticket')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/dashbaordpage/ticket-support.blade.php ENDPATH**/ ?>