...
<div class="card bg-custom border p-25">
    <div class="row">
        <form action="<?php echo e(url('editAmenities-update/'.$amenitydata->id.'/'.$propertyid)); ?>" method="post">
           <?php echo csrf_field(); ?>
            <div class="col-lg-6">
                <div class="mb-3">
                   <label for="amenityName" class="form-label">Amenity Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="name" id="amenityName" placeholder="Enter amenity name" value="<?php echo e($amenitydata->name); ?>" required>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="mb-3">
                    ...
                    <select class="form-control form-select" name="status" id="amenityStatus">
                        <option value="1" <?php echo e($amenitydata->status == 1 ? 'selected' : ''); ?>>Active</option>
                        <option value="0" <?php echo e($amenitydata->status == 0 ? 'selected' : ''); ?>>Inactive</option>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/property/editAmenities.blade.php ENDPATH**/ ?>