...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item" aria-current="page"> <?php echo e(__('Manage Notice List')); ?></li>
<?php $__env->stopSection(); ?>
            ...
            <form action="" id="" class="search-form">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-3 d-flex align-items-center justify-content-end">
                            ...
                            <a href="<?php echo e(url('add-notice')); ?>" class="btn btn-secondary text-white"><i class="ti ti-circle-plus align-text-bottom"></i>  Create Manage Notice</a>
                        </div>
                    </div>
                </form>
        </div>
            ...
            <table class="table table-bordered table-striped" id="emailTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url('edit-notice')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/dashbaordpage/manage-notice.blade.php ENDPATH**/ ?>