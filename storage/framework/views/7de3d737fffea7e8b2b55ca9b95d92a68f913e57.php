                ...
                <!-- <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 mx-3">
                            ...
                            <h6 class="mb-0 text-secondary"><?php echo e(!empty($tenant->user) ? $tenant->user->email : '-'); ?></h6>
                            <h6 class="mb-0 text-secondary"><?php echo e(!empty($tenant->user) ? $tenant->user->phone_number : '-'); ?></h6>
                        </div>
                ...
                <div class="pb-0">
                    ...
                    <ul class="nav flex-column nav-tabs account-tabs box-card custom-theme" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="profile-tab" data-bs-toggle="tab" href="#profile_content" role="tab" aria-selected="true">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img class="img-radius img-fluid wid-80"
                                            src="<?php echo e(!empty($tenant->user) && !empty($tenant->user->profile) ? asset(Storage::url('upload/profile/' . $tenant->user->profile)) : asset(Storage::url('upload/profile/avatar.png'))); ?>"
                                    ...
                                    <div class="flex-grow-1 mx-3">
                                        <h5 class="mb-1">
                                            <?php echo e(ucfirst(optional($tenant->user)->first_name) . ' ' . ucfirst(optional($tenant->user)->last_name)); ?>

                                        </h5>
                                        <!-- <h6 class="mb-0 text-secondary"><?php echo $tenant->LeaseLeftDay(); ?></h6> -->
                                        <!-- <h6 class="mb-0 text-secondary"><?php echo e(optional($tenant->user)->email ?? '-'); ?></h6>
                                        <h6 class="mb-0 text-secondary"><?php echo e(optional($tenant->user)->phone_number ?? '-'); ?></h6> -->
                                    </div>
                                </div>
                            </a>
                        </li>
                        ...
                        <!-- Contract Tab -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="contract-tab" data-bs-toggle="tab" href="#contract_content" role="tab" aria-selected="false">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
        ...
        <div class="col-lg-8 col-xxl-9">
            <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card-body allwhite px-3">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        <tbody>
                                            <tr>
                                                <td><b class="text-header"><?php echo e(__('Emergency Contact No.')); ?></b></td>
                                                <td>:</td>
                                                <td><?php echo e(!empty($tenant->user->emergency_phone_number) ? $tenant->user->emergency_phone_number : '-'); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td><?php echo e(!empty($statesdata->name) ? $statesdata->name : '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td><b class="text-header"><?php echo e(__('City')); ?></b></td>
                                                <td>:</td>
                                                <td><?php echo e(!empty($cities->name) ? $cities->name : '-'); ?></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($tenant->lease_start_date); ?></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><?php echo e($tenant->lease_end_date); ?></td>
                                            </tr>
                    ...
                    <div class="tab-pane fade" id="contract_content" role="tabpanel" aria-labelledby="contract-tab">
                            <div class="card box-card w-100">
                            <div class="card-header">
                                <h5><?php echo e(__('Contract Setup')); ?></h5>
                            </div>
                    ...
                    <div class="tab-pane fade" id="invoice_content" role="tabpanel" aria-labelledby="invoice-tab">
                        <div class="card box-card w-100">
                            <div class="card-header">
                                <h5><?php echo e(__('Payment Schedule')); ?></h5>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="tab-pane fade" id="notice_content" role="tabpanel" aria-labelledby="notice-tab">
                        <div class="card box-card w-100">
                            <div class="card-header">
                                <h5><?php echo e(__('Generate Notice')); ?></h5>
                            </div>
                    ...
                    <div class="tab-pane fade" id="document_content" role="tabpanel" aria-labelledby="document-tab">
                        ...
                        <div class="card box-card w-100 send-document document-card d-none">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5><?php echo e(__('Send Document')); ?></h5>
                        ...
                        <div class="card box-card w-100 view-document document-card d-none">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h5><?php echo e(__('View Document')); ?></h5>
                                <span class="btn btn-outline-secondary back-btn">Back</span>
                            </div>
                            <div class="card-body">
                                <div class="card theme-card">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/tenant/show.blade.php ENDPATH**/ ?>