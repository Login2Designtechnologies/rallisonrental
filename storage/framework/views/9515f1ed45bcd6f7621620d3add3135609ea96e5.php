...
<div class="card bg-custom border p-25">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="card box-card w-100 repeater">
                        ...
                        <table class="display dataTable cell-border" data-repeater-list="types">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-lg-3 px-2"><?php echo e(__('Amount')); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/invoice/create.blade.php ENDPATH**/ ?>