                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <div class="form-group ">
                                                        ...
                                                        <?php echo e(Form::select('type', ['' => 'Select'] + $types, $property->type ?? null, ['class' => 'form-control basic-select required-field', 'required' => 'required'])); ?>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('name', null, ['class' => 'form-control required-field', 'placeholder' => __('Enter Property Name'), 'required' => 'required'])); ?>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::file('thumbnail', ['class' => 'form-control required-field', 'required' => 'required'])); ?>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <div class="form-group ">
                                                        ...
                                                        <?php echo e(Form::textarea('address', null, ['class' => 'form-control required-field', 'rows' => 1, 'placeholder' => __('Enter Property Address'), 'required' => 'required'])); ?>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::text('zip_code', null, ['class' => 'form-control required-field', 'placeholder' => __('Enter Property Zip Code'), 'required' => 'required'])); ?>
                                        ...
                                        <div class="row">
                                            <div class="dropzone needsclick" id='demo-upload' action="#">
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <h3 class="mb-0"><?php echo e(__('Drop files here or click to upload.')); ?></h3>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body w-100">
                                <div class="row unit_list d-none">
                                        <div class="form-group col-md-6">
                                            ...
                                            <?php echo e(Form::text('unitname[]', null, ['class' => 'form-control', 'placeholder' => __('Enter unit name')])); ?>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <?php echo e(Form::textarea('notes[]', null, ['class' => 'form-control', 'rows' => 1, 'placeholder' => __('Enter notes')])); ?>
                        ...
                        <div class="card border bg-custom bg-white">
                            <div class="card-body w-100">
                                <div class="row">
                                        ...
                                        <div>
                                            <label class="me-3">
                                                <?php echo e(Form::radio('is_billed', 'yes', false, ['class' => 'form-check-input is-billed'])); ?> Yes
                                            </label>
                                            <label class="">
                                                <?php echo e(Form::radio('is_billed', 'no', true, ['class' => 'form-check-input is-billed'])); ?> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card border bg-custom bg-white">
                            <div class="card-body w-100">
                                <div class="row">
                                        ...
                                        <div>
                                            <label class="me-3">
                                                <?php echo e(Form::radio('utilities', 'yes','false', false, ['class' => 'form-check-input'])); ?> Yes
                                            </label>
                                            <label class="">
                                                <?php echo e(Form::radio('utilities', 'no','true', false, ['class' => 'form-check-input'])); ?> No
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $utilities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $utilitval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr id="row2-<?php echo e($utilitval->id); ?>">
                                                            ...
                                                            <td class="text-center">
                                                                <button class="btn btn-sm btn-warning editUtilitiesBtn"
...
<script>
    $(document).on('click', '#saveUtilities', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(url('property-utilities-store')); ?>",
            type: "POST",
                    ...
                    response.data.forEach(function(item) {
                        ...
                        $('#UtilitiesTable tbody').append(`
                            <tr id="row2-${item.id}">
                                ...
                                <td>${statusText}</td>
                                <td class="text-center">
                                    <button class="btn btn-sm btn-warning editUtilitiesModal"
                                        data-id="${item.id}"
                                        data-name="${item.name}"
...
<script>
    $(document).on('click', '#saveAmenity', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(url('property-amenities-store')); ?>", 
            type: "POST",
...
<script>
    ...
    $(document).on('click', '#updateAmenity', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(url('property-amenities-update')); ?>",
            type: "POST",
...
<script>
    ...
    $(document).on('click', '#updateUtilities', function (e) {
        ...
        $.ajax({
            url: "<?php echo e(url('property-Utilities-update')); ?>",
            type: "POST",
            ...
            <div class="modal-body">
                <form id="amenityForm">
                  <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-3">
                        <label for="amenityAmount" class="form-label">Cost ($)</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/dodgerblue-lapwing-476569.hostingersite.com/public_html/resources/views/property/create.blade.php ENDPATH**/ ?>