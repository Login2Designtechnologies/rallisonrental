...
<!--  -->
<div class="card bg-custom border p-25 d-none">
    <div class="row">
                ...
                <div class="card box-card w-100">
                    <ul class="nav flex-column nav-tabs account-tabs box-card custom-theme" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="nav1" data-bs-toggle="tab" href="#nav1" role="tab" aria-selected="true">
                        ...
                        <!-- Invoice Tab -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav2" data-bs-toggle="tab" href="#nav2" role="tab" aria-selected="false" tabindex="-1">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <!-- Invoice Tab -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav3" data-bs-toggle="tab" href="#nav3" role="tab" aria-selected="false" tabindex="-1">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                        ...
                        <!-- Document Tab -->
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav4" data-bs-toggle="tab" href="#nav4" role="tab" aria-selected="false" tabindex="-1">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
            ...
            <div class="col-lg-8 col-xxl-9 d-flex">
                <div class="w-100">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="contract_content" role="tabpanel" aria-labelledby="contract-tab">
                            <div class="card box-card w-100">
