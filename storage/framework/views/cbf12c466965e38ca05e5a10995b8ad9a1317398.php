                                    ...
                                    <div class="card-body p-3">
                                                ...
                                                <div class="d-flex">
                                                   ...
                                                   <div>
                                                    <a href="<?php echo e(route('tenant.show', $tenant->id)); ?>">
                                                        <h4>
                                                            <span class="d-block"><?php echo e(ucfirst(!empty($tenant->user) ? $tenant->user->first_name : '')); ?></span>
                                                            <span class="d-block"><?php echo e(ucfirst(!empty($tenant->user) ? $tenant->user->last_name : '')); ?></span>
                                                        </h4>
                                                    </a>
                                                        <!-- <a href="<?php echo e(route('tenant.show', $tenant->id)); ?>">
                                                        ...
                                                        <!-- <h6 class="text-truncate  d-flex align-items-center"><?php echo e($tenant->address); ?></h6> -->
                                                   </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0 text-sm"><?php echo e(__('Property Name')); ?> :</p>
                                                <h6 class="mb-0">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0 text-sm"><?php echo e(__('Unit (if exist) ')); ?> :</p>
                                                <h6 class="mb-0">
                                            ...
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Lease Start Date')); ?> :</p>
                                                <!-- <h6 class="mb-0"><?php echo e(dateFormat($tenant->lease_start_date)); ?></h6> -->
                                                
                                                <h6 class="mb-0" style="min-height:14px"><?php echo e($tenant->lease_start_date); ?></h6>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Lease End Date')); ?> :</p>
                                                <!-- <h6 class="mb-0"><?php echo e(dateFormat($tenant->lease_end_date)); ?></h6> -->
                                                 
                                                 <h6 class="mb-0"><?php echo e($tenant->lease_end_date); ?></h6>
                                            </div>

                                            <!-- <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Phone')); ?> :</p>
                                                <h6 class="mb-0">
                                                    <?php echo e(!empty($tenant->user) ? $tenant->user->phone_number : '-'); ?></h6>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Emergency Contact No.')); ?> :</p>
                                                <h6 class="mb-0"><?php echo e(!empty($tenant->user->emergency_phone_number) ? $tenant->user->emergency_phone_number : '-'); ?></h6>
                                            </div> -->

                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Amount Due')); ?> :</p>
                                                <h6 class="mb-0">
                                                    $</h6>
                                            </div>
                                            <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Amount Past Due')); ?> :</p>
                                                <h6 class="mb-0"> $</h6>
                                            </div>
                                            <!-- <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Property')); ?> :</p>
                                                <h6 class="mb-0">
                                                    <?php echo e(!empty($tenant->properties) ? $tenant->properties->name : '-'); ?>
                                            ...
                                            <!-- <div class="col-sm-6 mb-3">
                                                <p class="mb-0  text-sm"><?php echo e(__('Unit')); ?> :</p>
                                                <h6 class="mb-0">
                                                    <?php echo e(!empty($tenant->units) ? $tenant->units->name : '-'); ?>
                                            ...
                                            <div class="btn-block">
                                                <a href="<?php echo e(route('tenant.show', $tenant->id)); ?>" class="btn btn-md btn-outline-secondary">Manage Tenant</a>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/tenant/index.blade.php ENDPATH**/ ?>