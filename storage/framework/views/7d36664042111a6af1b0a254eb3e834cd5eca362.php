                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3 text-end">
                                        <span
                                            class="h1 mb-0 d-block fw-semibold"><?php echo e(!empty($Section_2_content_value['Box1_number']) ? $Section_2_content_value['Box1_number'] : '150+'); ?></span>
                                        <span
                                            class="h5 mb-0 d-block"><?php echo e(!empty($Section_2_content_value['Box1_title']) ? $Section_2_content_value['Box1_title'] : 'Components'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card feature-card mb-0 bg-blue-200">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3 text-end">
                                        <span
                                            class="h1 mb-0 d-block fw-semibold"><?php echo e(!empty($Section_2_content_value['Box2_number']) ? $Section_2_content_value['Box2_number'] : '8+'); ?></span>
                                        <span
                                            class="h5 mb-0 d-block"><?php echo e(!empty($Section_2_content_value['Box2_title']) ? $Section_2_content_value['Box2_title'] : 'Application'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card feature-card mb-0 bg-purple-200">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 ms-3 text-end">
                                        <span
                                            class="h1 mb-0 d-block fw-semibold"><?php echo e(!empty($Section_2_content_value['Box3_number']) ? $Section_2_content_value['Box3_number'] : '100+'); ?></span>
                                        <span
                                            class="h5 mb-0 d-block"><?php echo e(!empty($Section_2_content_value['Box3_title']) ? $Section_2_content_value['Box3_title'] : 'Pages'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="bg-body pricingpricing" id="pricing">
                <div class="container">
                    <div class="row justify-content-center title">
                        <div class="col-md-9 col-lg-6 text-center">
                            <h2 class="h1">
                                <?php echo e(!empty($Section_5_content_value['Sec5_title']) ? $Section_5_content_value['Sec5_title'] : 'Affordable Pricing Based On Your Needs'); ?>

                            </h2>
                            <p class="text-lg">
                                <?php echo e(!empty($Section_5_content_value['Sec5_info']) ? $Section_5_content_value['Sec5_info'] : 'Berry has conceptul working apps like Chat, Inbox, E-commerce, Invoice, Kanban,and Calendar'); ?>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <h2 class="mb-0 text-white">
                                    <?php echo e(!empty($Section_8_content_value['Sec8_title']) ? $Section_8_content_value['Sec8_title'] : 'Choose Berry for'); ?>
        ...
        <section class="frameworks-section" id="faqs">
            <div class="container">
                <div class="row justify-content-center title">
                    <div class="col-md-9 col-lg-6 text-center">
                        <h2 class="h1">
                            <?php echo e(!empty($Section_9_content_value['Sec9_title']) ? $Section_9_content_value['Sec9_title'] : 'FAQ'); ?>
                            ...
                            <?php else: ?>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body text-muted">
                                            If your End Product which is sold - Then only your required Extended
                                            License. i.e. If you take
                                            subscription charges
                                            (monthly, yearly, etc...) from your end users in this case you required
                                            Extended License.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            6 Months of Support Includes with 1 year of free updates. We are happy to
                                            solve your bugs, issue.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            Yes, Berry Support the TypeScript and it is only available in Plus and
                                            Extended License.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapse-four" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body text-muted">
                                            Berry is our flagship React Dashboard Template and we always add the new
                                            features for the long
                                            run. You can check
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            <?php echo e(!empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : 'About Berry'); ?>
...
<?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/layouts/landing.blade.php ENDPATH**/ ?>