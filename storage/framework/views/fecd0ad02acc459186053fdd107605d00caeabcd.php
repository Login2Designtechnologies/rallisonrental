                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="form-group col-lg-6 col-md-6">
                                ...
                                <?php echo e(Form::text('phone_number', $user->phone_number, ['class' => 'form-control', 'placeholder' => __('xxx-xxx-xxxx')])); ?>

                            </div> -->

                            <div class="form-group col-lg-6 col-md-6">
                                <?php echo e(Form::label('phone_number', 'Phone Number', ['class' => 'form-label'])); ?> <span class="text-danger">*</span>
                                <?php echo e(Form::text('phone_number', $user->phone_number, ['class' => 'form-control phone_number', 'placeholder' => 'xxx-xxx-xxxx'])); ?>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                <?php echo e(Form::label('emergency_contact', 'Emergency Contact Number', ['class' => 'form-label'])); ?> <span class="text-danger">*</span>
                                <?php echo e(Form::text('emergency_phone_number', $user->emergency_phone_number, ['class' => 'form-control phone_number', 'placeholder' => 'xxx-xxx-xxxx'])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if($user->profile): ?>
                                    <div class="mt-2">
                                        <a href="<?php echo e(asset(Storage::url('upload/profile/' . $user->profile))); ?>" target="_blank">
                                            <img src="<?php echo e(asset(Storage::url('upload/profile/' . $user->profile))); ?>" 
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group ">
                                ...
                                <?php echo e(Form::textarea('address', null, ['class' => 'form-control', 'rows' => 1, 'placeholder' => __('Enter Address')])); ?>
                            ...
                            <div class="form-group col-lg-4 col-md-4">
                                ...
                                <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $citieval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($citieval->id); ?>" <?php echo e($tenant->city == $citieval->id ? 'selected' : ''); ?> style=""><?php echo e($citieval->name); ?></option>
                            ...
                            <div class="form-group col-lg-6 col-md-6">
                                ...
                                <div class="unit_div">
                                   <select class="form-control" id="unitall" name="unit" required>
                                        ...
                                        <?php $__currentLoopData = $propertyunit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $propertyval): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($propertyval->id); ?>" 
                                                <?php echo e(old('unit', $tenantsedit->unit ?? '') == $propertyval->id ? 'selected' : ''); ?>>
                                                <?php echo e($propertyval->name ?? ''); ?>
                ...
                <div class="card box-card w-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="preview mt-2 small text-muted" style="color: white !important;"></div>
                            <?php if($user->personal_document): ?>
                                <div class="mt-2">
                                    <a href="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->personal_document))); ?>" target="_blank">
                                        <img src="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->personal_document))); ?>" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                                    <div class="small text-muted">Current photo</div>
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="preview mt-2 small text-muted" style="color: white !important;"></div>
                            <?php if($user->ic_document): ?>
                                <div class="mt-2">
                                    <a href="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->ic_document))); ?>" target="_blank">
                                        <img src="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->ic_document))); ?>" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="preview mt-2 small text-muted" style="color: white !important;"></div>
                            <?php if($user->miscellaneous): ?>
                                <div class="mt-2">
                                    <a href="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->miscellaneous))); ?>" target="_blank">
                                        <img src="<?php echo e(asset(Storage::url('upload/tenantdocument/' . $user->miscellaneous))); ?>" 
                                             alt="Profile" class="rounded" style="height:60px">
                                    </a>
                                    <div class="small text-muted">Current</div>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, city) {
                            $('#company_city').append('<option value="'+ city.id +'" style="">'+ city.name +'</option>');
                        });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/dodgerblue-lapwing-476569.hostingersite.com/public_html/resources/views/tenant/edit.blade.php ENDPATH**/ ?>