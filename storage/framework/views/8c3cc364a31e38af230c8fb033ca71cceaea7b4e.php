<head>
    ...
    <!-- [Page specific CSS] end -->
     ...
     <link href="<?php echo e(asset('public/vendor/css/select2/select2.css')); ?>" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style.css?v=dasddsdsdsdd%')); ?>" id="main-style-link" />
    ...
    <!-- <link href="<?php echo e(asset('css/l2dstyle.css?v=fddsds%')); ?>"  rel="stylesheet"> -->
     <link href="<?php echo e(asset('css/l2dstyle.css')); ?>?v=<?php echo e(time()); ?>" rel="stylesheet">

</head>
<?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/admin/head.blade.php ENDPATH**/ ?>