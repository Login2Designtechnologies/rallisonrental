                        ...
                        <div class="col-sm-6 col-md-4 col-xxl-3">
                            <div class="card product-card">
                                <div class="card-img-top">
                                 <?php if(!empty($thumbnail) && $thumbnail !== 'default.jpg'): ?>
                                    <img src="<?php echo e(asset(Storage::url('upload/thumbnail')) . '/' . $thumbnail); ?>"
                                        alt="<?php echo e($property->name); ?>" class="img-prod" />
                                 <?php else: ?>
                                        <img 
                                            src="<?php echo e($thumbnail && file_exists(public_path('storage/upload/thumbnail/' . $thumbnail)) 
                                                ? asset('storage/upload/thumbnail/' . $thumbnail) 
                                                : asset('https://placehold.co/270x220')); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/dodgerblue-lapwing-476569.hostingersite.com/public_html/resources/views/property/index.blade.php ENDPATH**/ ?>