...
<div class="card bg-custom border p-25">
    <div class="row">
        <div class="col-sm-12">
            <div class="card box-card w-100" style="background: transparent;">
                                        ...
                                        <?php if(Gate::check('edit note') || Gate::check('delete note')): ?>
                                            <div class="d-flex align-items-start mb-3">
                                                <!-- <div class="flex-grow-1 "><?php echo e(dateFormat($note->created_at)); ?></div> -->
                                                 <div class="flex-grow-1"><?php echo e(dateFormat($note->created_at, 'm-d-y')); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/note/index.blade.php ENDPATH**/ ?>