                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 mb-4">
                                                ...
                                                <!-- <h6 class="mb-0"><?php echo e(dateFormat($contact->created_at)); ?></h6> -->
                                                 <h6 class="mb-0"><?php echo e(\Carbon\Carbon::parse($contact->created_at)->format('m-d-y')); ?></h6>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u527856812/domains/whitesmoke-jackal-127066.hostingersite.com/public_html/resources/views/contact/index.blade.php ENDPATH**/ ?>